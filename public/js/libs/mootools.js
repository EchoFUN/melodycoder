...
(function() {
    ...
    local.search = function(context, expression, append, first) {
        ...
        if ( typeof expression == 'string') {// expression is a string
            ...
            var simpleSelector = expression.match(reSimpleSelector); simpleSelectors:
            if (simpleSelector) {
            ...
            /*<query-selector-override>*/ querySelector:
        ...
        var currentItems, currentExpression, currentBit, lastBit, expressions = parsed.expressions; search:
    ...
    var combinators = {
        ...
        ' ' : function(node, tag, id, classes, attributes, pseudos, classList) {// all child nodes, any level
            ...
            if (this.isHTMLDocument) { getById:
                ...
                if (classes && node.getElementsByClassName && !this.brokenGEBCN) {
